    ...
    <>
      ...
      <div>
        ...
        <div className="ml-[17%] pt-16 pb-8 bg-white border-b-2 border-[#E8E8E8]  ">
          ...
          <p className="text-secondary  ml-9 text-[15px]">
...
Check your email and portal for updates.."
        ...
        // text="You may start exploring Shivorix Portal. However, for a proper quality review and writing process, allow us up to 24 to 48 hours to confirm that your application has been successful."
      />
    </>
  );
};
