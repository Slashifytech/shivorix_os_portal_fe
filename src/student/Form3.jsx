      ...
      <PopUp
        ...
        text1={
          role === "2"
            ...
            : "Thank You for applying to become an official Shivorix Portal Partner Student."
        }
        text3={role !=="2" &&"All good things take time."}
        text4={role !=="2" &&"Thanks for your patience!"}
        text={role !=="2" && "You may start exploring Shivorix Portal. However, for a proper quality review and writing process, allow us up to 24 to 48 hours to confirm that your application has been successful."
        }/>
    </div>
  );
};
