  ...
  return (
    <div className=" font-poppins">
      ...
      <PopUp
        ...
        isPopUp={isPopUp}
        text=" You may start exploring Shivorix Portal. However, for a proper quality review and writing process, allow us up to 24 to 48 hrs to confirm that your application has been successful."
        heading="Your Agent Registration is Complete!"
        text3="All good things take time."
        text4="Thanks for your patience!"
        text1="Thank You for applying to become an official Shivorix Portal Partner Agent."
      />
    </div>
  );
};
